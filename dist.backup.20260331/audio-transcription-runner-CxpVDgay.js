import { O as runExec, _t as resolveAgentModelFallbackValues, vt as resolveAgentModelPrimaryValue } from "./run-with-concurrency-BXSUl5Nj.js";
import { B as shouldLogVerbose, O as createSubsystemLogger, R as logVerbose, X as resolvePreferredOpenClawTmpDir } from "./logger-Bj0Xl6pn.js";
import { A as resolveApiKeyForProvider, c as normalizeProviderId, dt as isInboundPathAllowed, et as loadConfig, ft as mergeInboundPathRoots, h as normalizeGoogleModelId, k as requireApiKey, pt as resolveIMessageAttachmentRoots, ut as DEFAULT_IMESSAGE_ATTACHMENT_ROOTS, vr as resolveOpenClawAgentDir } from "./model-selection-DQ0Z0JPw.js";
import { y as normalizeChatType } from "./plugins-CYmt_3q0.js";
import { E as kindFromMime, S as getFileExtension, b as detectMime, w as isAudioFileName } from "./image-ops-Bx7cfcpZ.js";
import { E as ensureOpenClawModelsJson, t as describeImageWithModel } from "./image-Ci1Js9ha.js";
import { a as getDefaultMediaLocalRoots, n as fetchRemoteMedia, t as MediaFetchError } from "./fetch-D1ipIHMY.js";
import { n as fetchWithTimeout } from "./fetch-timeout-BNgFcHwW.js";
import { t as fetchWithSsrFGuard } from "./fetch-guard-OiskJOjE.js";
import { n as executeWithApiKeyRotation, r as parseGeminiAuth, t as collectProviderApiKeysForExecution } from "./api-key-rotation-Mhds5mZY.js";
import { n as resolveProxyFetchFromEnv } from "./proxy-fetch-Cb4oTY_l.js";
...
const defaultImportPiSdk = () => import("./pi-model-discovery-CYrk5wXt.js").then((n) => n.r);
