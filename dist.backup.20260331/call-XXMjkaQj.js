...
import { H as loadConfig, y as resolveSecretRefString } from "./auth-profiles-mTj_3EiL.js";
import { b as shortenHomeInString, s as ensureDir$1, t as CONFIG_DIR, v as resolveUserPath } from "./utils-C5WN6czr.js";
import { n as logError, t as logDebug } from "./logger-DUUyiuLB.js";
...
import { h as GATEWAY_CLIENT_NAMES, m as GATEWAY_CLIENT_MODES, p as GATEWAY_CLIENT_IDS } from "./message-channel-Be-gqLbb.js";
import { a as isSecureWebSocketUrl, t as rawDataToString } from "./ws-lgJJfM9Q.js";
import { l as trimToUndefined, s as resolveGatewayCredentialsFromConfig, t as GatewaySecretRefUnavailableError } from "./credentials-DiatshlT.js";
import { n as readJsonFile, r as writeJsonAtomic, t as createAsyncLock } from "./json-files-CRHgCkhP.js";
import { t as INPUT_PROVENANCE_KIND_VALUES } from "./input-provenance-BLbzcN96.js";
import { a as resolvePairingPaths, i as pruneExpiredPending, n as verifyPairingToken, r as rejectPendingPairingRequest, t as generatePairingToken } from "./pairing-token-DSWSMr10.js";
...
//#endregion
export { validateExecApprovalResolveParams as $, approveDevicePairing as $t, validateChatSendParams as A, validateSessionsUsageParams as At, validateCronListParams as B, validateWebLoginStartParams as Bt, validateAgentsListParams as C, validateSessionsCompactParams as Ct, validateChatAbortParams as D, validateSessionsPreviewParams as Dt, validateChannelsStatusParams as E, validateSessionsPatchParams as Et, validateConfigSchemaLookupResult as F, validateTalkConfigParams as Ft, validateCronUpdateParams as G, validateWizardStatusParams as Gt, validateCronRunParams as H, validateWizardCancelParams as Ht, validateConfigSchemaParams as I, validateTalkModeParams as It, validateDevicePairRejectParams as J, parseSessionLabel as Jt, validateDevicePairApproveParams as K, ErrorCodes as Kt, validateConfigSetParams as L, validateToolsCatalogParams as Lt, validateConfigGetParams as M, validateSkillsInstallParams as Mt, validateConfigPatchParams as N, validateSkillsStatusParams as Nt, validateChatHistoryParams as O, validateSessionsResetParams as Ot, validateConfigSchemaLookupParams as P, validateSkillsUpdateParams as Pt, validateExecApprovalRequestParams as Q, normalizeDeviceMetadataForPolicy as Qt, validateConnectParams as R, validateUpdateRunParams as Rt, validateAgentsFilesSetParams as S, validateSendParams as St, validateChannelsLogoutParams as T, validateSessionsListParams as Tt, validateCronRunsParams as U, validateWizardNextParams as Ut, validateCronRemoveParams as V, validateWebLoginWaitParams as Vt, validateCronStatusParams as W, validateWizardStartParams as Wt, validateDeviceTokenRevokeParams as X, buildDeviceAuthPayloadV3 as Xt, validateDevicePairRemoveParams as Y, buildDeviceAuthPayload as Yt, validateDeviceTokenRotateParams as Z, normalizeDeviceMetadataForAuth as Zt, validateAgentWaitParams as _, validatePollParams as _t, randomIdempotencyKey as a, requestDevicePairing as an, validateModelsListParams as at, validateAgentsFilesGetParams as b, validateSecretsResolveParams as bt, ADMIN_SCOPE as c, summarizeDeviceTokens as cn, validateNodeInvokeParams as ct, isNodeRoleMethod as d, roleScopesAllow as dn, validateNodePairApproveParams as dt, ensureDeviceToken as en, validateExecApprovalsGetParams as et, resolveLeastPrivilegeOperatorScopesForMethod as f, loadGatewayTlsRuntime as fn, validateNodePairListParams as ft, validateAgentParams as g, verifyDeviceSignature as gn, validateNodeRenameParams as gt, validateAgentIdentityParams as h, normalizeDevicePublicKeyBase64Url as hn, validateNodePairVerifyParams as ht, ensureExplicitGatewayAuth as i, removePairedDevice as in, validateLogsTailParams as it, validateConfigApplyParams as j, validateSkillsBinsParams as jt, validateChatInjectParams as k, validateSessionsResolveParams as kt, READ_SCOPE as l, updatePairedDeviceMetadata as ln, validateNodeInvokeResultParams as lt, formatValidationErrors as m, loadOrCreateDeviceIdentity as mn, validateNodePairRequestParams as mt, callGateway as n, listDevicePairing as nn, validateExecApprovalsNodeSetParams as nt, resolveExplicitGatewayAuth as o, revokeDeviceToken as on, validateNodeDescribeParams as ot, GatewayClient as p, deriveDeviceIdFromPublicKey as pn, validateNodePairRejectParams as pt, validateDevicePairListParams as q, errorShape as qt, callGatewayLeastPrivilege as r, rejectDevicePairing as rn, validateExecApprovalsSetParams as rt, resolveGatewayCredentialsWithSecretInputs as s, rotateDeviceToken as sn, validateNodeEventParams as st, buildGatewayConnectionDetails as t, getPairedDevice as tn, validateExecApprovalsNodeGetParams as tt, authorizeOperatorScopesForMethod as u, verifyDeviceToken as un, validateNodeListParams as ut, validateAgentsCreateParams as v, validatePushTestParams as vt, validateAgentsUpdateParams as w, validateSessionsDeleteParams as wt, validateAgentsFilesListParams as x, validateSecretsResolveResult as xt, validateAgentsDeleteParams as y, validateRequestFrame as yt, validateCronAddParams as z, validateWakeParams as zt };
