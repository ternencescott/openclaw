import { a as logVerbose, c as shouldLogVerbose, m as getChildLogger } from "./globals-BM8hKFm0.js";
import { C as sleep, T as toWhatsappJid, f as isSelfChatMode, m as normalizeE164, p as jidToE164, r as clamp, v as resolveJidToE164 } from "./utils-DC4zYvW0.js";
import { Dn as recordPendingHistoryEntryIfEnabled, En as buildHistoryContextFromEntries, Fn as createInboundDebouncer, Ft as resolveInboundSessionEnvelopeContext, Hn as createDedupeCache, In as resolveInboundDebounceMs, Jr as buildAgentSessionKey, Ln as formatInboundEnvelope, Mn as shouldAckReactionForWhatsApp, Nn as dispatchReplyWithBufferedBlockDispatcher, On as enqueueSystemEvent, St as parseActivationCommand, Tn as createReplyPrefixOptions, Xr as resolveAgentRoute, Yr as deriveLastRoutePolicy, Zr as resolveInboundLastRouteSessionKey, dn as computeBackoff, dr as resolveMessagePrefix, fn as sleepWithAbort, gn as resolveMentionGating, hn as issuePairingChallenge, nr as hasControlCommand, or as buildMentionRegexes, rr as shouldComputeCommandAuthorized, si as finalizeInboundContext, sn as createConnectedChannelStatusPatch, sr as normalizeMentionText, t as getReplyFromConfig, ur as resolveIdentityNamePrefix, xt as normalizeGroupActivation } from "./reply-BcfVto6Y.js";
import { f as defaultRuntime, t as createSubsystemLogger } from "./subsystem-C9Xgeyrw.js";
...
import { o as resolveChannelGroupPolicy, s as resolveChannelGroupRequireMention } from "./dock-CeHYT_BX.js";
import { ct as resolveGroupSessionKey, f as updateLastRoute, l as recordSessionMetaFromInbound, s as loadSessionStore } from "./sessions-CKeAXJPm.js";
...
import { c as getWebAuthAgeMs, i as resolveWhatsAppAccount, m as readWebSelfId, o as resolveWhatsAppMediaMaxBytes } from "./accounts-WRgl0tJ1.js";
import { c as resolveStorePath } from "./paths-BWOXmNIW.js";
import { t as getAgentScopedMediaLocalRoots } from "./local-roots-R12NBqSD.js";
import { X as toLocationContext, Y as formatLocationText } from "./send-DhpDxhdS.js";
import { a as loadWebMedia, d as chunkMarkdownTextWithMode, h as resolveTextChunkLimit, m as resolveChunkMode, s as resolveMarkdownTableMode } from "./ir-DFYfpa3w.js";
...
import { c as upsertChannelPairingRequest } from "./pairing-store-CndzxHPD.js";
import { f as readStoreAllowFromForDmPolicy, g as resolvePinnedMainDmOwnerFromAllowlist, h as resolveDmGroupAccessWithLists, m as resolveDmGroupAccessWithCommandGate } from "./read-only-account-inspect-B0dLsD47.js";
import { n as recordChannelActivity } from "./channel-activity-CJY8LQxd.js";
import { t as convertMarkdownTables } from "./tables-B3H_ZDZF.js";
import { r as formatDurationPrecise } from "./format-duration-CMgw_WII.js";
import { r as setActiveWebListener } from "./active-listener-CBfWhNU0.js";
import { i as markdownToWhatsApp, r as sendReactionWhatsApp } from "./outbound-Cph39PJY.js";
import { i as waitForWaConnection, n as formatError, r as getStatusCode, t as createWaSocket } from "./session-DObK50gf.js";
