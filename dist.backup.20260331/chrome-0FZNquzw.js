import { R as isNotFoundPathError, z as isPathInside } from "./run-with-concurrency-BXSUl5Nj.js";
import { O as createSubsystemLogger, X as resolvePreferredOpenClawTmpDir, a as CONFIG_DIR } from "./logger-Bj0Xl6pn.js";
import { At as normalizeIpAddress, K as resolveSecretRefValues, Mr as resolveSecretInputRef, Ot as isLoopbackIpAddress, et as loadConfig, jr as normalizeSecretInputString, kt as isPrivateOrLoopbackIpAddress, vt as secretRefKey } from "./model-selection-DQ0Z0JPw.js";
import { a as isErrno } from "./errors-IUnFHymY.js";
import { i as openFileWithinRoot, t as SafeOpenError } from "./fs-safe-B9COjfwE.js";
import { o as isPrivateNetworkAllowedByPolicy, s as resolvePinnedHostnameWithPolicy, t as hasProxyEnvConfigured } from "./proxy-env-COiwrWh6.js";
...
function resolveOpenClawUserDataDir(profileName = DEFAULT_OPENCLAW_BROWSER_PROFILE_NAME, dataDir) {
	const baseDir = dataDir || path.join(CONFIG_DIR, "browser");
	return path.join(baseDir, profileName, "user-data");
}
...
async function launchOpenClawChrome(resolved, profile) {
	...
	const userDataDir = resolveOpenClawUserDataDir(profile.name, resolved.dataDir);
