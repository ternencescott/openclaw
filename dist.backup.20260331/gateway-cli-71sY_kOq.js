import { a as logVerbose, d as colorize, f as isRich, g as getResolvedLoggerSettings, h as getLogger, m as getChildLogger, p as theme, s as setVerbose } from "./globals-Bv4ZcVWM.js";
...
import { a as setConsoleSubsystemFilter, f as defaultRuntime, n as runtimeForLogger, o as setConsoleTimestampPrefix, t as createSubsystemLogger } from "./subsystem-Cf9yS0UI.js";
import "./boolean-DTgd5CzD.js";
import { i as logAcceptedEnvOption, r as isTruthyEnvValue } from "./entry.js";
import { Ar as resolveHooksGmailModel, At as AVATAR_MAX_BYTES, Bi as DEFAULT_PROVIDER, Cr as normalizeModelSelection, Dn as applyMergePatch, Er as resolveAllowedModelRef, Fr as resolveThinkingDefault, G as readConfigFileSnapshot, H as loadConfig, Hn as buildTalkConfigResponse, K as readConfigFileSnapshotForWrite, L as migrateLegacyConfig, Lt as looksLikeAvatarPath, Mt as isAvatarHttpUrl, Nr as resolveSubagentConfiguredModelSelection, Nt as isAvatarImageDataUrl, On as applyLegacyMigrations, Or as resolveConfiguredModelRef, Pi as normalizeSecretInput, U as parseConfigJson5, Un as resolveAgentMaxConcurrent, W as readBestEffortConfig, Wn as resolveSubagentMaxConcurrent, X as validateConfigObjectWithPlugins, Y as writeConfigFile, Z as OpenClawSchema, br as isCliProvider, kn as ensureControlUiAllowedOriginsForNonLoopbackBind, kr as resolveDefaultModelForAgent, mr as buildAllowedModelSet, mt as parseByteSize, pr as isPidAlive, pt as parseDurationMs, q as resolveConfigSnapshotHash, vr as getModelRefStatus, z as createConfigIO, zi as DEFAULT_MODEL } from "./auth-profiles-mTj_3EiL.js";
import { t as formatCliCommand } from "./command-format-BTnLVWI8.js";
import { A as resolveDefaultAgentWorkspaceDir, C as DEFAULT_SOUL_FILENAME, E as ensureAgentWorkspace, O as isWorkspaceOnboardingCompleted, S as DEFAULT_MEMORY_FILENAME, T as DEFAULT_USER_FILENAME, a as resolveAgentDir, b as DEFAULT_IDENTITY_FILENAME, c as resolveAgentModelFallbacksOverride, d as resolveDefaultAgentId, g as DEFAULT_AGENTS_FILENAME, i as resolveAgentConfig, j as resolveWorkspaceTemplateDir, l as resolveAgentSkillsFilter, m as resolveSessionAgentId, n as listAgentEntries, r as listAgentIds, u as resolveAgentWorkspaceDir, v as DEFAULT_BOOTSTRAP_FILENAME, w as DEFAULT_TOOLS_FILENAME, x as DEFAULT_MEMORY_ALT_FILENAME, y as DEFAULT_HEARTBEAT_FILENAME } from "./agent-scope-DF-nzI8H.js";
...
import { E as isPlainObject, S as sleep, T as truncateUtf16Safe, n as clamp, s as ensureDir, v as resolveUserPath, x as shortenHomePath } from "./utils-C5WN6czr.js";
import { a as openBoundaryFileSync, f as isNotFoundPathError, g as matchesSkillFilter, i as openBoundaryFile, o as openVerifiedFileSync, s as sameFileIdentity, t as resolveOpenClawPackageRoot } from "./openclaw-root-DFJGXT24.js";
import { i as logWarn, t as logDebug } from "./logger-DUUyiuLB.js";
...
import { A as triggerInternalHook, D as clearInternalHooks, O as createInternalHookEvent, b as canonicalizePathVariant, h as createEmptyPluginRegistry, k as registerInternalHook, t as CHANNEL_IDS, u as getActivePluginRegistry, v as PROTECTED_PLUGIN_ROUTE_PREFIXES, y as canonicalizePathForSecurity } from "./registry-DoLLbW4m.js";
import { u as isTestDefaultMemorySlotDisabled } from "./manifest-registry-Ba187z7Z.js";
import "./dock-CtpWzQ0n.js";
import { i as isSilentReplyText, n as SILENT_REPLY_TOKEN } from "./tokens-Duelq45x.js";
import { $n as buildOutboundSessionContext, An as resolveSendPolicy, Ar as resolveTtsConfig, Bn as initSubagentRegistry, C as resolveAgentDeliveryPlan, Cn as DEFAULT_INPUT_TIMEOUT_MS, Cr as clearBootstrapSnapshot, Ct as normalizeOptionalSessionKey, D as createOutboundSendDeps$1, Dn as resolveInputFileLimits, Dr as isTtsProviderConfigured, Dt as migrateLegacyCronPayload, E as createDefaultDeps, En as normalizeMimeList, Er as isTtsEnabled, Et as normalizeRequiredName, F as createReplyPrefixOptions, Fr as textToSpeech, Ft as closeTrackedBrowserTabsForSessions, G as createReplyDispatcher, Gr as waitForActiveTasks, Gt as parseVerboseOverride, Hn as listDescendantRunsForRequester, Hr as markGatewayDraining, I as buildHistoryContextFromEntries, Ir as OPENAI_TTS_MODELS, It as applyBrowserProxyPaths, J as buildBareSessionResetPrompt, Jn as runSubagentAnnounceFlow, Jt as unbindThreadBindingsBySessionKey, K as getTotalPendingReplies, Kr as CommandLane, Kt as normalizeSpawnedRunMetadata, Ln as countActiveDescendantRuns, Lr as OPENAI_TTS_VOICES, Lt as persistBrowserProxyFiles, Mr as resolveTtsProviderOrder, Mt as detectSuspiciousPatterns, Nn as isAbortRequestText, Nr as setTtsEnabled, Nt as getHookType, Or as resolveTtsApiKey, Ot as normalizeLegacyDeliveryInput, Pn as stopSubagentsForRequester, Pr as setTtsProvider, Pt as isExternalHookSession, Q as createOpenClawTools, Qn as clearSessionQueues, Rt as resolveSessionAuthProfileOverride, Sn as DEFAULT_INPUT_IMAGE_MIMES, St as normalizeOptionalAgentId, T as createOutboundSendDeps, Tn as extractImageContentFromSource, Tr as getTtsProvider, Tt as normalizePayloadToSystemText, Ur as resetAllLanes, Ut as applyModelOverrideToSessionEntry, Vr as getTotalQueueSize, W as dispatchInboundMessage, Wr as setCommandLaneConcurrency, Wt as applyVerboseOverride, X as setCliSessionId, Xn as readLatestAssistantReply, Y as getCliSessionId, Yn as resolveAnnounceTargetFromKey, Yr as stripHeartbeatToken, Yt as normalizeGroupActivation, Z as runCliAgent, Zt as loadProviderUsageSummary, _ as requestBodyErrorToText, _r as resolveAgentIdentity, _t as writeRestartSentinel, a as getPluginToolMeta, ar as resolveCronStyleNow, at as resolveSessionDeliveryTarget, bt as normalizeCronJobPatch, c as loadOpenClawPlugins, cr as getAgentRunContext, ct as resetDirectoryCache, dn as isSystemEventContextChanged, dt as consumeRestartSentinel, er as runEmbeddedPiAgent, et as ensureOutboundSessionEntry, ft as formatDoctorNonInteractiveHint, g as readJsonBodyWithLimit, gr as resolveAgentSessionDirs, h as handleSlackHttpRequest, hr as getAcpSessionManager, ht as summarizeRestartSentinel, it as resolveOutboundTarget, j as resolveAgentAvatar, jr as resolveTtsPrefsPath, jt as buildSafeExternalPrompt, kn as normalizeSendPolicy, kr as resolveTtsAutoMode, l as createPluginRuntime, lr as onAgentEvent, mn as requestHeartbeatNow, n as applyToolPolicyPipeline, nr as getActiveEmbeddedRunCount, o as resolvePluginTools, or as clearAgentRunContext, ot as resolveOutboundChannelPlugin, p as resolveAgentOutboundIdentity, pr as resolveBootstrapWarningSignaturesSeen, pt as formatRestartSentinelMessage, qn as resolveAgentTimeoutMs, qt as resolveIngressWorkspaceOverrideForSpawnedRun, r as buildDefaultToolPolicyPipelineSteps, rr as waitForEmbeddedPiRunEnd, sr as emitAgentEvent, tn as formatZonedTimestamp, tr as abortEmbeddedPiRun, tt as resolveOutboundSessionRoute, un as enqueueSystemEvent, ur as registerAgentRunContext, ut as runWithModelFallback, vt as normalizeHttpWebhookUrl, w as resolveAgentOutboundTarget, wn as extractFileContentFromSource, wr as clearBootstrapSnapshotOnSessionRollover, wt as normalizeOptionalText, x as agentCommandFromIngress, xn as DEFAULT_INPUT_IMAGE_MAX_BYTES, xr as resolveUserTimezone, xt as inferLegacyName, yt as normalizeCronJobCreate, zr as getActiveTaskCount } from "./compact-DYAmGi3u.js";
import { g as buildChannelAccountBindings, n as listChannelPlugins, r as normalizeChannelId, t as getChannelPlugin } from "./plugins-BkoiCBu-.js";
import { i as resolveWhatsAppAccount } from "./accounts-LPEl32gb.js";
import { p as normalizeWhatsAppTarget } from "./channel-config-helpers-BDId9EPL.js";
import "./send-BTfpm6_x.js";
import "./send-DubKBcKN.js";
import { a as getMachineDisplayName, i as startBrowserControlServiceFromConfig, n as createBrowserRouteDispatcher, r as createBrowserControlContext } from "./with-timeout-mNv6sM7u.js";
import { j as runGlobalGatewayStopSafely, k as getGlobalHookRunner, o as normalizeReplyPayloadsForDelivery, t as deliverOutboundPayloads } from "./deliver-ynCg3guV.js";
import { d as startDiagnosticHeartbeat, f as stopDiagnosticHeartbeat, h as isDiagnosticsEnabled } from "./diagnostic-BqRzZMD2.js";
import "./accounts-_PYzdhne.js";
import { c as detectMime } from "./image-ops-CQrO7d64.js";
import { C as saveCronStore, S as resolveCronStorePath, x as loadCronStore } from "./send-vE9IhYcb.js";
import "./pi-model-discovery-CN3fiV3-.js";
import { _ as normalizeGatewayClientMode, f as GATEWAY_CLIENT_CAPS, g as hasGatewayClientCap, h as GATEWAY_CLIENT_NAMES, i as isGatewayMessageChannel, l as normalizeMessageChannel, m as GATEWAY_CLIENT_MODES, n as isDeliverableMessageChannel, p as GATEWAY_CLIENT_IDS, r as isGatewayCliClient, s as isWebchatClient, t as INTERNAL_MESSAGE_CHANNEL } from "./message-channel-Be-gqLbb.js";
import "./pi-embedded-helpers-CMEderlr.js";
import { C as resolveToolProfilePolicy, _ as collectExplicitAllowlist, y as mergeAlsoAllowPolicy } from "./sandbox-Dd2Cr63Z.js";
...
import { i as enableTailscaleServe, n as disableTailscaleServe, o as getTailnetHostname, r as enableTailscaleFunnel, t as disableTailscaleFunnel } from "./tailscale-Bxls2k-9.js";
import { t as safeEqualSecret } from "./secret-equal-BpENUFFz.js";
import { n as pickPrimaryTailnetIPv4, r as pickPrimaryTailnetIPv6 } from "./tailnet-00rx0H2v.js";
import { c as normalizeHostHeader, d as resolveGatewayBindHost, f as resolveGatewayListenHosts, i as isLoopbackHost, l as pickPrimaryLanIPv4, n as isLocalishHost, o as isTrustedProxyAddress, r as isLoopbackAddress, s as isValidIPv4, t as rawDataToString, u as resolveClientIp } from "./ws-lgJJfM9Q.js";
import { a as resolveGatewayAuth, c as AUTH_RATE_LIMIT_SCOPE_SHARED_SECRET, i as isLocalDirectRequest, l as createAuthRateLimiter, n as authorizeHttpGatewayConnect, o as AUTH_RATE_LIMIT_SCOPE_DEVICE_TOKEN, r as authorizeWsControlUiGatewayConnect, s as AUTH_RATE_LIMIT_SCOPE_HOOK_AUTH, t as assertGatewayAuthConfigured, u as normalizeRateLimitClientIp } from "./auth-IGdehW-m.js";
import { a as readGatewayPasswordEnv, o as readGatewayTokenEnv } from "./credentials-DiatshlT.js";
import { t as resolveConfiguredSecretInputString } from "./resolve-configured-secret-input-string-BQCPKZxv.js";
import { d as mergeGatewayTailscaleConfig, l as ensureGatewayStartupAuth, u as mergeGatewayAuthConfig } from "./server-context-DzPMAe_K.js";
import { f as hasBinary } from "./frontmatter-CDYnjLEC.js";
import "./env-overrides-BeDt30xz.js";
import { n as assertNoPathAliasEscape } from "./path-alias-guards-D_v2YTP8.js";
import { i as loadWorkspaceSkillEntries, r as buildWorkspaceSkillSnapshot } from "./skills-B3eXdmA5.js";
import "./paths-DBHbY8ck.js";
import { a as testRegexWithBoundedInput, i as compileSafeRegex } from "./redact-SKlSb-Ph.js";
import { o as isErrno, r as formatErrorMessage } from "./errors-Duls987w.js";
import { i as openFileWithinRoot, l as writeFileWithinRoot, s as readLocalFileSafely, t as SafeOpenError } from "./fs-safe-n_u5Hqlt.js";
import { n as SsrFBlockedError } from "./proxy-env-CQcXW_eY.js";
import { n as cleanOldMedia } from "./store-kjkrRAMQ.js";
import { n as inspectPortUsage, o as formatPortDiagnostics, t as ensurePortAvailable } from "./ports-DOBLq-G-.js";
import { t as movePathToTrash } from "./trash-CsUKAlUm.js";
import "./server-middleware-D36oNYKH.js";
import { n as readJsonFile, r as writeJsonAtomic, t as createAsyncLock } from "./json-files-CRHgCkhP.js";
import { $ as resolveExplicitAgentSessionKey, A as cleanupArchivedSessionTranscripts, B as jsonUtf8Bytes, C as mergeDeliveryContext, D as archiveFileOnDisk, F as stripEnvelopeFromMessage, H as evaluateSessionFreshness, I as stripEnvelopeFromMessages, J as mergeSessionEntry, M as readSessionPreviewItemsFromTranscript, O as archiveSessionTranscripts, P as resolveSessionTranscriptCandidates, Q as resolveAgentMainSessionKey, R as stripInlineDirectiveTagsForDisplay, T as normalizeSessionDeliveryFields, W as resolveSessionResetPolicy, X as setSessionRuntimeModel, Z as canonicalizeMainSessionAlias, et as resolveMainSessionKey, j as readSessionMessages, k as capArrayByJsonBytes, n as parseSessionThreadInfo, o as archiveRemovedSessionTranscripts, p as updateSessionStore, rt as snapshotSessionOrigin, s as loadSessionStore, t as extractDeliveryInfo, tt as resolveMainSessionKeyFromConfig, ut as cleanStaleLockFiles, x as deliveryContextFromSession, z as stripInlineDirectiveTagsFromMessageForDisplay } from "./sessions-BqrgkUq8.js";
import { c as resolveStorePath, i as resolveSessionTranscriptPath, n as resolveSessionFilePath, r as resolveSessionFilePathOptions, s as resolveSessionTranscriptsDirForAgent } from "./paths-BCX3TKIK.js";
import { i as normalizeInputProvenance } from "./input-provenance-BLbzcN96.js";
import "./chat-envelope-B0leI413.js";
import { o as estimateBase64DecodedBytes } from "./tool-images-BnvE1YX0.js";
import { a as normalizeElevatedLevel, c as normalizeUsageDisplay, d as supportsXHighThinking, l as normalizeVerboseLevel, n as formatXHighModelHint, o as normalizeReasoningLevel, s as normalizeThinkLevel, t as formatThinkingLevels } from "./thinking-DykY2Fzj.js";
...
import { n as loadModelCatalog } from "./model-catalog-BrnDjT5b.js";
import "./fetch-aEprHAvD.js";
import { v as registerUnhandledRejectionHandler } from "./audio-transcription-runner-xUVq32Gp.js";
import { t as fetchWithSsrFGuard } from "./fetch-guard-DlpOQOcG.js";
import { b as extractTextFromChatContent } from "./image-DCicTb0Y.js";
...
import { a as ToolInputError } from "./target-errors-Cq0s5cjB.js";
import { r as isRestartEnabled } from "./commands-BNTk8Bcu.js";
import "./commands-registry-B1qR0h_Y.js";
import { c as hasNonzeroUsage, i as loadSessionUsageTimeSeries, n as loadCostUsageSummary, r as loadSessionCostSummary, s as deriveSessionTotalTokens, t as discoverAllSessions } from "./session-cost-usage-5CCZbVhO.js";
...
import { n as GATEWAY_AUTH_SURFACE_PATHS, p as isKnownSecretTargetId, r as evaluateGatewayAuthSurfaceStates } from "./runtime-config-collectors-CvPeIBWe.js";
import "./command-secret-targets-BE9nonvF.js";
import "./connection-auth-DetJrcZD.js";
import { C as normalizeControlUiBasePath, S as buildControlUiAvatarUrl, c as handleReset, w as resolveAssistantAvatarUrl, x as CONTROL_UI_AVATAR_PREFIX } from "./onboard-helpers-BZvS4-ob.js";
import "./prompt-style-Bcr283QM.js";
import "./pairing-labels-B7hqAWNX.js";
import { i as resolveMemoryBackendConfig, r as getMemorySearchManager } from "./memory-cli-BFAWzUOR.js";
import { i as resolveMemorySearchConfig } from "./manager-D3msdE3r.js";
...
import { t as buildWorkspaceSkillStatus } from "./skills-status-B-LyfH6C.js";
import { i as onHeartbeatEvent, r as getLastHeartbeatEvent, t as resolveHeartbeatVisibility } from "./heartbeat-visibility-JITFjIz1.js";
import { t as ensureOpenClawCliOnPath } from "./path-env-CrZEPD8b.js";
import { n as DEFAULT_GATEWAY_HTTP_TOOL_DENY } from "./dangerous-tools-DlTp6G0s.js";
import { t as readSecretFromFile } from "./secret-file-COaA7FBV.js";
import { n as inheritOptionFromParent } from "./command-options-C578vcye.js";
import { t as WizardCancelledError } from "./prompts-CBu-6GZI.js";
import { t as resolveChannelDefaultAccountId } from "./helpers-GjxwhXvN.js";
import { a as pruneAgentConfig, i as loadAgentIdentity, r as findAgentEntryIndex, t as applyAgentConfig } from "./agents.config-DMyEsKhP.js";
import { t as isWithinDir } from "./path-safety-CvQiYYt3.js";
import "./install-safe-path-CVF-qUBX.js";
import "./skill-scanner-JCapMgtj.js";
import { n as formatConfigIssueLines } from "./issue-format-CI_-MgiE.js";
import { t as buildChannelAccountSnapshot } from "./status-gIF8FOit.js";
import "./channels-status-issues-B0WC0NAB.js";
import { a as buildBaseHints, i as applySensitiveHints, n as redactConfigSnapshot, o as mapSensitivePaths, r as restoreRedactedValues, s as applyDerivedTags, t as redactConfigObject } from "./redact-snapshot-CuxPaM1R.js";
...
import "./lifecycle-core-BFLFxe0p.js";
import "./systemd-hints-CXa8jzon.js";
import { t as parsePort$1 } from "./parse-port-SkgwTeUu.js";
import { n as addGatewayServiceCommands } from "./daemon-cli-DiuzVe6b.js";
import { r as probeGateway } from "./probe-auth-BvOUzL0m.js";
import "./diagnostics-CSvaMszi.js";
import "./table-BiXQnzQs.js";
import { n as resolveWideAreaDiscoveryDomain, r as writeWideAreaGatewayZone } from "./widearea-dns-vKh80L3n.js";
import { i as toOptionString, n as extractGatewayMiskeys, r as maybeExplainGatewayServiceStop, t as describeUnknownError } from "./shared-CGJhlyTG.js";
import { t as discoverGatewayBeacons } from "./bonjour-discovery-BE0E-Fh2.js";
import { i as pickGatewaySelfPresence, r as getStatusSummary } from "./status-CSkhFHTT.js";
import { a as styleHealthChannelLine, c as setHeartbeatsEnabled, l as startHeartbeatRunner, n as getHealthSnapshot, s as runHeartbeatOnce, t as formatHealthChannelLines, u as isCronSystemEvent } from "./health-DxzllMcV.js";
import { a as resolveControlUiRootSync, i as resolveControlUiRootOverrideSync, t as ensureControlUiAssetsBuilt } from "./control-ui-assets-0Xxy9Jtx.js";
import { m as normalizeUpdateChannel, n as checkUpdateStatus, o as resolveNpmChannelTag, r as compareSemverStrings } from "./channel-account-context-D-mDIqSp.js";
import { a as resolveCommandSecretsFromActiveRuntimeSnapshot, i as prepareSecretsRuntimeSnapshot, n as clearSecretsRuntimeSnapshot, r as getActiveSecretsRuntimeSnapshot, t as activateSecretsRuntimeSnapshot } from "./runtime-DIs_1IxL.js";
import "./onboarding.secret-input-CAvaJvAT.js";
import { t as runOnboardingWizard } from "./onboarding-Ca0jM7NM.js";
import { a as sendApnsAlert, c as parseMessageWithAttachments, d as shouldLogWs, f as summarizeAgentEventForWsLog, i as resolveApnsAuthConfigFromEnv, l as formatForLog, n as normalizeApnsEnvironment, o as sendApnsBackgroundWake, p as setGatewayWsLogStyle, s as normalizeRpcAttachmentsToChatAttachments, t as loadApnsRegistration, u as logWs } from "./push-apns-Cr3hztod.js";
import { _ as buildGogWatchStartArgs, g as buildGogWatchServeArgs, i as ensureTailscaleEndpoint, w as resolveGmailHookRuntimeConfig } from "./gmail-setup-utils-DmU4zBZG.js";
import { n as isNodeCommandAllowed, r as resolveNodeCommandAllowlist } from "./node-command-policy-pJ1REufS.js";
import { n as collectEnabledInsecureOrDangerousFlags } from "./audit-B_dPA1ce.js";
import "./node-service-CAmcSqOD.js";
import "./status.update-BPU2YsIg.js";
import { t as installSkill } from "./skills-install-yUkkbz9r.js";
import { t as runGatewayUpdate } from "./update-runner-BsoSS-ua.js";
import { i as shouldIncludeHook, r as resolveHookConfig, t as loadWorkspaceHookEntries } from "./workspace-D_p4fiID.js";
import { n as forceFreePortAndWait, r as waitForPortBindable } from "./ports-DD4vm6Tl.js";
...
const nodeHandlers = {
	...
	"node.event": async ({ params, respond, context, client }) => {
		...
		await respondUnavailableOnThrow(respond, async () => {
			const { handleNodeEvent } = await import("./server-node-events-C85pQTUd.js");
...
const usageHandlers = {
	...
	"sessions.usage.logs": async ({ respond, params }) => {
		...
		if (!resolved) return;
		const { config, entry, agentId, sessionId, sessionFile } = resolved;
		const { loadSessionLogs } = await import("./session-cost-usage-5CCZbVhO.js").then((n) => n.a);
...
async function startBrowserControlServerIfEnabled() {
	...
	const mod = override ? await import(override) : await import("./server-Bjq4tkEJ.js");
...
async function startGatewayServer(port = 18789, opts = {}) {
	...
	if (!minimalTestGateway) (async () => {
		const { recoverPendingDeliveries } = await import("./delivery-queue-gLCiF0so.js").then((n) => n.n);
		const { deliverOutboundPayloads } = await import("./deliver-ynCg3guV.js").then((n) => n.n);
