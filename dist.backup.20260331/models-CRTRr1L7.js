...
import { d as colorize, f as isRich$1, p as theme } from "./globals-Bv4ZcVWM.js";
import { t as CONFIG_PATH } from "./paths-BfR2LXbA.js";
import { $n as upsertAuthProfile, Bi as DEFAULT_PROVIDER, Ci as isNonSecretApiKeyMarker, H as loadConfig, J as setRuntimeConfigSnapshot, K as readConfigFileSnapshotForWrite, Or as resolveConfiguredModelRef, Qn as setAuthProfileOrder, Si as shouldEnableShellEnvFallback, Tr as parseModelRef, Vi as resolveAuthProfileDisplayLabel, Xn as listProfilesForProvider, _i as resolveEnvApiKey, _r as findNormalizedProviderValue, cr as resolveAuthStorePathForDisplay, gi as resolveAwsSdkEnvVarName, gr as buildModelAliasIndex, hi as resolveApiKeyForProvider, jr as resolveModelRefFromString, kr as resolveDefaultModelForAgent, l as resolveProfileUnusableUntilForDisplay, lr as resolveOpenClawAgentDir, n as resolveAuthProfileEligibility, nr as ensureAuthProfileStore, pi as getCustomProviderApiKey, pt as parseDurationMs, r as resolveAuthProfileOrder, wr as normalizeProviderId, xr as modelKey, y as resolveSecretRefString, yi as getShellEnvAppliedKeys, zi as DEFAULT_MODEL } from "./auth-profiles-mTj_3EiL.js";
import { t as formatCliCommand } from "./command-format-BTnLVWI8.js";
import { A as resolveDefaultAgentWorkspaceDir, M as resolveAgentModelFallbackValues, N as resolveAgentModelPrimaryValue, P as toAgentModelListLike, a as resolveAgentDir, c as resolveAgentModelFallbacksOverride, d as resolveDefaultAgentId, s as resolveAgentExplicitModelPrimary, u as resolveAgentWorkspaceDir } from "./agent-scope-DF-nzI8H.js";
...
import { $t as formatUsageWindowSummary, Bt as DEFAULT_OAUTH_WARN_MS, Ht as formatRemainingShort, Rr as resolveModelWithRegistry, Vt as buildAuthHealthSummary, Zt as loadProviderUsageSummary, en as resolveUsageProviderId, er as runEmbeddedPiAgent, mr as describeFailoverError, zt as maskApiKey } from "./compact-DYAmGi3u.js";
import { n as discoverModels, t as discoverAuthStorage } from "./pi-model-discovery-CN3fiV3-.js";
import { i as resolveSessionTranscriptPath, s as resolveSessionTranscriptsDirForAgent } from "./paths-BCX3TKIK.js";
import { t as ensureOpenClawModelsJson } from "./models-config-CQ5ytykT.js";
import { n as loadModelCatalog } from "./model-catalog-BrnDjT5b.js";
import { i as getModelsCommandSecretTargetIds, s as resolveCommandSecretRefsViaGateway } from "./command-secret-targets-BE9nonvF.js";
import { f as openUrl } from "./onboard-helpers-BZvS4-ob.js";
import { n as stylePromptMessage, r as stylePromptTitle, t as stylePromptHint } from "./prompt-style-Bcr283QM.js";
import { r as withProgressTotals } from "./progress-fMgIMdPa.js";
...
import { a as formatMs, c as loadValidConfigOrThrow, d as resolveKnownAgentId, f as resolveModelKeysFromEntries, i as ensureFlagCompatibility, l as mergePrimaryFallbackConfig, m as updateConfig, n as applyOpenAICodexModelDefault, o as formatTokenK, p as resolveModelTarget, r as applyDefaultModelPrimaryUpdate, s as isLocalBaseUrl, t as OPENAI_CODEX_DEFAULT_MODEL, u as normalizeAlias } from "./openai-codex-model-default-CitO2lfi.js";
import { Ct as writeOAuthCredentials, d as applyAuthProfileConfig, n as validateAnthropicSetupToken } from "./auth-token-CGWE7BrY.js";
import { n as logConfigUpdated } from "./logging-BfIBddi5.js";
import { a as loginOpenAICodexOAuth, c as resolvePluginProviders, i as resolveProviderMatch, n as mergeConfigPatch, o as createVpsAwareOAuthHandlers, r as pickAuthMethod, s as isRemoteEnvironment, t as applyDefaultModel } from "./provider-auth-helpers-BoyIYzxX.js";
...
async function modelsListCommand(opts, runtime) {
	ensureFlagCompatibility(opts);
	const { ensureAuthProfileStore } = await import("./auth-profiles-mTj_3EiL.js").then((n) => n.t);
