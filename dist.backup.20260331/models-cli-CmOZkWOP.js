...
import { d as colorize, f as isRich$1, p as theme } from "./globals-BM8hKFm0.js";
import { S as shortenHomePath } from "./utils-DC4zYvW0.js";
import "./thinking-BYwvlJ3S.js";
import { Ct as loadProviderUsageSummary, Et as resolveUsageProviderId, Tt as formatUsageWindowSummary, a as buildAuthHealthSummary, en as describeFailoverError, i as DEFAULT_OAUTH_WARN_MS, kr as resolveModelWithRegistry, o as formatRemainingShort, r as maskApiKey, w as runEmbeddedPiAgent } from "./reply-BcfVto6Y.js";
import { A as resolveDefaultAgentWorkspaceDir, M as resolveAgentModelFallbackValues, N as resolveAgentModelPrimaryValue, P as toAgentModelListLike, a as resolveAgentDir, c as resolveAgentModelFallbacksOverride, d as resolveDefaultAgentId, s as resolveAgentExplicitModelPrimary, u as resolveAgentWorkspaceDir } from "./agent-scope-Cbp0nOOm.js";
...
import { Ai as resolveOpenClawAgentDir, Ci as ensureAuthProfileStore, Fi as resolveAuthProfileDisplayLabel, Gi as DEFAULT_PROVIDER, On as parseDurationMs, Pt as resolveSecretRefString, Wi as DEFAULT_MODEL, _i as listProfilesForProvider, _t as resolveAuthProfileEligibility, bi as upsertAuthProfile, c as modelKey, d as normalizeProviderId, et as getCustomProviderApiKey, f as parseModelRef, fi as shouldEnableShellEnvFallback, g as resolveDefaultModelForAgent, h as resolveConfiguredModelRef, i as findNormalizedProviderValue, it as resolveEnvApiKey, ki as resolveAuthStorePathForDisplay, li as getShellEnvAppliedKeys, ln as setRuntimeConfigSnapshot, nt as resolveApiKeyForProvider, ot as isNonSecretApiKeyMarker, r as buildModelAliasIndex, rn as loadConfig, rt as resolveAwsSdkEnvVarName, sn as readConfigFileSnapshotForWrite, v as resolveModelRefFromString, vt as resolveAuthProfileOrder, wt as resolveProfileUnusableUntilForDisplay, yi as setAuthProfileOrder } from "./model-selection-D5oXKIQF.js";
...
import { t as ensureOpenClawModelsJson } from "./models-config-CJ-JZF5q.js";
...
import { i as resolveSessionTranscriptPath, s as resolveSessionTranscriptsDirForAgent } from "./paths-BWOXmNIW.js";
...
import { i as getModelsCommandSecretTargetIds, s as resolveCommandSecretRefsViaGateway } from "./command-secret-targets-Cg-fYSaJ.js";
import "./session-cost-usage-CkCo2kVx.js";
import "./connection-auth-DbI_Rn7H.js";
import { f as openUrl } from "./onboard-helpers-Vb5HpP-H.js";
...
import { n as runCommandWithRuntime, t as resolveOptionFromCommand } from "./cli-utils-CVpegkfr.js";
import "./help-format-FDT8xd4M.js";
import { r as withProgressTotals } from "./progress-BZWDJTlm.js";
...
import { t as createClackPrompter } from "./clack-prompter-C2rZOXIQ.js";
import "./issue-format-DTzM3Cop.js";
import { t as renderTable } from "./table-CDJTNPtO.js";
import { t as inferParamBFromIdOrName } from "./model-param-b-DCQU_lXR.js";
import { n as redactSecrets } from "./format-CFSntTjd.js";
import { a as formatMs, c as loadValidConfigOrThrow, d as resolveKnownAgentId, f as resolveModelKeysFromEntries, i as ensureFlagCompatibility, l as mergePrimaryFallbackConfig, m as updateConfig, n as applyOpenAICodexModelDefault, o as formatTokenK, p as resolveModelTarget, r as applyDefaultModelPrimaryUpdate, s as isLocalBaseUrl, t as OPENAI_CODEX_DEFAULT_MODEL, u as normalizeAlias } from "./openai-codex-model-default-CqNE7y6d.js";
import { Ct as writeOAuthCredentials, d as applyAuthProfileConfig, n as validateAnthropicSetupToken } from "./auth-token-CvpQgKnT.js";
import { n as logConfigUpdated } from "./logging-MtSj7aeX.js";
import { a as loginOpenAICodexOAuth, c as resolvePluginProviders, i as resolveProviderMatch, l as githubCopilotLoginCommand, n as mergeConfigPatch, o as createVpsAwareOAuthHandlers, r as pickAuthMethod, s as isRemoteEnvironment, t as applyDefaultModel } from "./provider-auth-helpers-BL7Ox8Gz.js";
...
async function modelsListCommand(opts, runtime) {
	ensureFlagCompatibility(opts);
	const { ensureAuthProfileStore } = await import("./model-selection-D5oXKIQF.js").then((n) => n.gt);
