import { d as colorize, p as theme } from "./globals-Bv4ZcVWM.js";
...
import { $t as analyzeArgvCommand, H as loadConfig, Sn as resolveInlineCommandMatch, bn as POSIX_INLINE_COMMAND_FLAGS, cn as resolveCommandResolutionFromArgv, gn as normalizeExecutableToken, ln as resolveExecutableFromPathEnv, rn as resolvePlannedSegmentArgv, un as POSIX_SHELL_WRAPPERS, vn as unwrapKnownDispatchWrapperInvocation, yn as unwrapKnownShellMultiplexerInvocation } from "./auth-profiles-mTj_3EiL.js";
import { t as formatCliCommand } from "./command-format-BTnLVWI8.js";
import { i as resolveAgentConfig } from "./agent-scope-DF-nzI8H.js";
import "./utils-C5WN6czr.js";
import { s as sameFileIdentity } from "./openclaw-root-DFJGXT24.js";
import { i as logWarn } from "./logger-DUUyiuLB.js";
...
import { a as getMachineDisplayName, i as startBrowserControlServiceFromConfig, n as createBrowserRouteDispatcher, r as createBrowserControlContext, t as withTimeout } from "./with-timeout-mNv6sM7u.js";
...
import { i as resolveBrowserConfig } from "./server-context-DzPMAe_K.js";
...
import { r as writeJsonAtomic } from "./json-files-CRHgCkhP.js";
import { n as evaluateShellAllowlist, r as resolveAllowAlwaysPatterns, t as evaluateExecAllowlist } from "./exec-approvals-allowlist-AujqtuSG.js";
import { n as resolveExecSafeBinRuntimePolicy } from "./exec-safe-bin-runtime-policy-BZorNRfd.js";
import { mn as loadOrCreateDeviceIdentity, p as GatewayClient } from "./call-XXMjkaQj.js";
import "./pairing-token-DSWSMr10.js";
import { _ as saveExecApprovals, c as normalizeExecApprovals, f as readExecApprovalsSnapshot, h as resolveExecApprovals, m as requiresExecApproval, n as addAllowlistEntry, o as mergeExecApprovalsSocketDefaults, p as recordAllowlistUse, r as ensureExecApprovals, v as requestJsonlSocket } from "./exec-approvals-oKbYU_E8.js";
import { n as resolveSystemRunCommand, o as normalizeSystemRunApprovalPlan, t as formatExecCommand } from "./system-run-command-rDdn4vLR.js";
import { _ as resolveNodeSystemdServiceName, g as resolveNodeLaunchAgentLabel, l as formatNodeServiceDescription, v as resolveNodeWindowsTaskName } from "./arg-split-DJKZOqeG.js";
import "./server-lifecycle-BAC9J8XA.js";
import { t as resolveGatewayConnectionAuth } from "./connection-auth-DetJrcZD.js";
...
import { l as buildNodeServiceEnvironment, n as resolveDaemonInstallRuntimeInputs, p as resolveNodeProgramArguments, t as emitDaemonInstallRuntimeWarning } from "./daemon-install-plan.shared-D06v-8EB.js";
...
import { a as createCliStatusTextStyles, f as resolveRuntimeStatusColor, g as installDaemonServiceAndEmit, h as createDaemonActionContext, i as runServiceUninstall, m as buildDaemonServiceSnapshot, r as runServiceStop, t as runServiceRestart } from "./lifecycle-core-BFLFxe0p.js";
import { c as buildPlatformRuntimeLogHints, l as buildPlatformServiceStartHints, u as formatRuntimeStatus } from "./systemd-hints-CXa8jzon.js";
