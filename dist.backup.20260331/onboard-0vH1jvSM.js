...
import { f as defaultRuntime, p as restoreTerminalState } from "./subsystem-C9Xgeyrw.js";
...
import { a as ensureWorkspaceAndSessions, b as waitForGatewayReachable, c as handleReset, g as resolveControlUiLinks, h as randomToken, n as applyWizardMetadata, t as DEFAULT_WORKSPACE, u as normalizeGatewayTokenInput } from "./onboard-helpers-Vb5HpP-H.js";
...
import "./daemon-runtime-Bx94r1xS.js";
import { t as runOnboardingWizard } from "./onboarding-CRomE5-H.js";
import { n as logConfigUpdated } from "./logging-MtSj7aeX.js";
import { i as normalizeLegacyOnboardAuthChoice, r as isDeprecatedAuthChoice, t as ONBOARD_PROVIDER_AUTH_FLAGS } from "./onboard-provider-auth-flags-B4Booc4Q.js";
import { t as applyOnboardingLocalWorkspaceConfig } from "./onboard-config-C8q-X8b_.js";
...
async function runNonInteractiveOnboardingLocal(params) {
	...
	if (authChoice !== "skip") {
		const { applyNonInteractiveAuthChoice } = await import("./auth-choice-Hn2BdQJ4.js");
	...
	if (opts.installDaemon) {
		const { installGatewayDaemonNonInteractive } = await import("./daemon-install-C_d7YwNJ.js");
	...
	if (!opts.skipHealth) {
		const { healthCommand } = await import("./health-CYIjG5rX.js").then((n) => n.i);
