...
import { f as defaultRuntime, p as restoreTerminalState } from "./subsystem-Cf9yS0UI.js";
...
import { a as ensureWorkspaceAndSessions, b as waitForGatewayReachable, c as handleReset, g as resolveControlUiLinks, h as randomToken, n as applyWizardMetadata, t as DEFAULT_WORKSPACE, u as normalizeGatewayTokenInput } from "./onboard-helpers-BZvS4-ob.js";
import { t as WizardCancelledError } from "./prompts-CBu-6GZI.js";
import { t as createClackPrompter } from "./clack-prompter-TjBORd0f.js";
import { t as assertSupportedRuntime } from "./runtime-guard-CGqgXWWP.js";
...
import { i as normalizeLegacyOnboardAuthChoice, r as isDeprecatedAuthChoice, t as ONBOARD_PROVIDER_AUTH_FLAGS } from "./onboard-provider-auth-flags-DYKZguRJ.js";
import { t as applyOnboardingLocalWorkspaceConfig } from "./onboard-config-DnsEXzRJ.js";
...
async function runNonInteractiveOnboardingLocal(params) {
	...
	if (authChoice !== "skip") {
		const { applyNonInteractiveAuthChoice } = await import("./auth-choice-BUZOfc9I.js");
	...
	if (opts.installDaemon) {
		const { installGatewayDaemonNonInteractive } = await import("./daemon-install-CaWAxLzz.js");
	...
	if (!opts.skipHealth) {
		const { healthCommand } = await import("./health-DxzllMcV.js").then((n) => n.i);
