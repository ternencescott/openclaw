import { I as resolvePathViaExistingAncestorSync, O as runExec, S as ensureAgentWorkspace, W as normalizeHyphenSlug, Y as buildAgentMainSessionKey, _ as DEFAULT_HEARTBEAT_FILENAME, b as DEFAULT_TOOLS_FILENAME, ct as normalizeOptionalAccountId, et as normalizeAgentId, f as resolveSessionAgentId, g as DEFAULT_BOOTSTRAP_FILENAME, h as DEFAULT_AGENT_WORKSPACE_DIR, i as resolveAgentConfig, j as openBoundaryFile, m as DEFAULT_AGENTS_FILENAME, nt as resolveAgentIdFromSessionKey, q as DEFAULT_AGENT_ID, tt as normalizeMainKey, v as DEFAULT_IDENTITY_FILENAME, x as DEFAULT_USER_FILENAME, y as DEFAULT_SOUL_FILENAME } from "./run-with-concurrency-BXSUl5Nj.js";
import { a as resolveGatewayPort, d as resolveRequiredHomeDir, n as STATE_DIR } from "./paths-GBpjI3o0.js";
import { E as truncateUtf16Safe, M as defaultRuntime, O as createSubsystemLogger, h as normalizeE164, y as resolveUserPath } from "./logger-Bj0Xl6pn.js";
import { Cr as formatCliCommand, K as resolveSecretRefValues, Mr as resolveSecretInputRef, Sr as isPidAlive, Yt as CHANNEL_IDS, Z as createConfigIO, at as writeConfigFile, br as resolveProcessScopedMap, bt as parseDurationMs, dr as parseBooleanValue, et as loadConfig, ir as containsEnvVarReference, kr as hasConfiguredSecretInput, vt as secretRefKey, xr as getProcessStartTime, xt as parseByteSize, yt as getBlockedNetworkModeReason } from "./model-selection-DQ0Z0JPw.js";
import { d as getChannelDock, o as normalizeThinkLevel } from "./thinking-DGUHJGw-.js";
import { r as normalizeChannelId, y as normalizeChatType } from "./plugins-CYmt_3q0.js";
import { t as generateSecureToken } from "./secure-random-D8DfzL9q.js";
import { i as getImageMetadata, m as normalizeMessageChannel, n as buildImageResizeSideGrid, p as listDeliverableMessageChannels, s as resizeToJpeg, t as IMAGE_REDUCE_QUALITY_STEPS } from "./image-ops-Bx7cfcpZ.js";
import { A as DEFAULT_DOWNLOAD_DIR, B as DEFAULT_AI_SNAPSHOT_EFFICIENT_MAX_CHARS, C as ensureChromeExtensionRelayServer, D as resolveCdpReachabilityTimeouts, F as resolveWritablePathWithinRoot, L as normalizeBrowserFormField, M as DEFAULT_UPLOAD_DIR, N as resolveExistingPathsWithinRoot, R as isLoopbackHost, T as CDP_JSON_NEW_TIMEOUT_MS, U as DEFAULT_OPENCLAW_BROWSER_COLOR, V as DEFAULT_AI_SNAPSHOT_MAX_CHARS, W as DEFAULT_OPENCLAW_BROWSER_PROFILE_NAME, _ as withBrowserNavigationPolicy, a as resolveOpenClawUserDataDir, b as fetchOk, c as resolveBrowserExecutableForPlatform, f as normalizeCdpWsUrl, g as assertBrowserNavigationResultAllowed, h as assertBrowserNavigationAllowed, i as launchOpenClawChrome, j as DEFAULT_TRACE_DIR, l as captureScreenshot, m as InvalidBrowserNavigationUrlError, n as isChromeCdpReady, o as stopOpenClawChrome, p as snapshotAria, r as isChromeReachable, u as createTargetViaCdp, v as appendCdpPath, w as stopChromeExtensionRelayServer, y as fetchJson } from "./chrome-0FZNquzw.js";
import { a as syncSkillsToWorkspace, l as resolveSandboxInputPath, m as sanitizeEnvVars, u as resolveSandboxPath } from "./skills-BTZq2xsK.js";
import { t as PATH_ALIAS_POLICIES } from "./path-alias-guards-6cS80cow.js";
import { n as extractErrorCode, r as formatErrorMessage } from "./errors-IUnFHymY.js";
import { n as SsrFBlockedError } from "./proxy-env-COiwrWh6.js";
import { i as saveMediaBuffer, n as ensureMediaDir } from "./store-DW2t8iMG.js";
...
import { a as resolveSessionTranscriptPathInDir, i as resolveSessionTranscriptPath, n as resolveSessionFilePath, s as resolveStorePath, t as resolveDefaultSessionStorePath } from "./paths-CV9f-LYb.js";
import { t as emitSessionTranscriptUpdate } from "./transcript-events-BDSDxU8V.js";
import { t as sanitizeContentBlocksImages } from "./tool-images-3ALKTC_Y.js";
...
async function loadPwAiModule(mode) {
	try {
		return await import("./pw-ai-ZLHycFWA.js");
	} catch (err) {
...
async function closePlaywrightBrowserConnection() {
	try {
		await (await import("./pw-ai-ZLHycFWA.js")).closePlaywrightBrowserConnection();
	} catch {}
}
