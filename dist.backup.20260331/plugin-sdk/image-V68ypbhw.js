import { J as resolveAgentModelPrimaryValue, q as resolveAgentModelFallbackValues } from "./run-with-concurrency-XmKq-xNS.js";
import { E as loadConfig, Ln as applyConfigEnvVars, Lr as normalizeSecretInput, T as getRuntimeConfigSourceSnapshot, gr as resolveImplicitProviders, hr as resolveImplicitCopilotProvider, ir as normalizeModelRef, mr as resolveImplicitBedrockProvider, pr as normalizeProviders, qn as resolveOpenClawAgentDir, r as requireApiKey, t as getApiKeyForModel, w as getRuntimeConfigSnapshot, wr as isNonSecretApiKeyMarker } from "./model-auth-KA9Yo_aB.js";
import { f as isRecord, x as shortenHomeInString } from "./logger-Cxu-Klb_.js";
import { P as sanitizeUserFacingText } from "./pi-embedded-helpers-nthLyyTb.js";
import { n as redactToolDetail } from "./redact-BLCBOszJ.js";
...
function loadPiModelDiscoveryRuntime() {
	piModelDiscoveryRuntimePromise ??= import("./pi-model-discovery-runtime-Cn1bbB8r.js");
