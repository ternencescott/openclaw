import { I as resolvePathViaExistingAncestorSync, O as runExec, S as ensureAgentWorkspace, W as normalizeHyphenSlug, Y as buildAgentMainSessionKey, _ as DEFAULT_HEARTBEAT_FILENAME, b as DEFAULT_TOOLS_FILENAME, ct as normalizeOptionalAccountId, et as normalizeAgentId, f as resolveSessionAgentId, g as DEFAULT_BOOTSTRAP_FILENAME, h as DEFAULT_AGENT_WORKSPACE_DIR, i as resolveAgentConfig, j as openBoundaryFile, m as DEFAULT_AGENTS_FILENAME, nt as resolveAgentIdFromSessionKey, q as DEFAULT_AGENT_ID, tt as normalizeMainKey, v as DEFAULT_IDENTITY_FILENAME, x as DEFAULT_USER_FILENAME, y as DEFAULT_SOUL_FILENAME } from "./run-with-concurrency-DCb27DCP.js";
import { a as resolveGatewayPort, d as resolveRequiredHomeDir, n as STATE_DIR } from "./paths-B9fwHuf0.js";
import { E as truncateUtf16Safe, M as defaultRuntime, O as createSubsystemLogger, h as normalizeE164, y as resolveUserPath } from "./logger-3VRkTvTU.js";
import { d as getChannelDock, o as normalizeThinkLevel } from "./thinking-R9DaUDTQ.js";
import { C as createConfigIO, E as loadConfig, G as parseDurationMs, K as parseByteSize, Lr as resolveSecretInputRef, Pr as hasConfiguredSecretInput, W as getBlockedNetworkModeReason, _n as getProcessStartTime, an as containsEnvVarReference, dr as parseBooleanValue, gn as resolveProcessScopedMap, j as writeConfigFile, jr as formatCliCommand, pr as secretRefKey, rr as CHANNEL_IDS, v as resolveSecretRefValues, vn as isPidAlive } from "./model-auth-CAsiNR3v.js";
import { r as normalizeChannelId, y as normalizeChatType } from "./plugins-Bxmcc12V.js";
import { t as SsrFBlockedError } from "./ssrf-BOg1vOQW.js";
import { g as getImageMetadata, m as buildImageResizeSideGrid, o as listDeliverableMessageChannels, p as IMAGE_REDUCE_QUALITY_STEPS, s as normalizeMessageChannel, y as resizeToJpeg } from "./message-channel-Cr-mg9HK.js";
import { t as PATH_ALIAS_POLICIES } from "./path-alias-guards-B-ts_bL2.js";
import { a as saveMediaBuffer, n as ensureMediaDir } from "./store-DE-s-LOY.js";
import { i as writeTextAtomic, r as writeJsonAtomic } from "./json-files-D-3S0Vvs.js";
import { a as resolveSessionTranscriptPathInDir, i as resolveSessionTranscriptPath, n as resolveSessionFilePath, s as resolveStorePath, t as resolveDefaultSessionStorePath } from "./paths-DhcZ7U8k.js";
import { t as emitSessionTranscriptUpdate } from "./transcript-events-DutjVURS.js";
import { A as DEFAULT_DOWNLOAD_DIR, B as DEFAULT_AI_SNAPSHOT_EFFICIENT_MAX_CHARS, C as ensureChromeExtensionRelayServer, D as resolveCdpReachabilityTimeouts, F as resolveWritablePathWithinRoot, L as normalizeBrowserFormField, M as DEFAULT_UPLOAD_DIR, N as resolveExistingPathsWithinRoot, R as isLoopbackHost, T as CDP_JSON_NEW_TIMEOUT_MS, U as DEFAULT_OPENCLAW_BROWSER_COLOR, V as DEFAULT_AI_SNAPSHOT_MAX_CHARS, W as DEFAULT_OPENCLAW_BROWSER_PROFILE_NAME, _ as withBrowserNavigationPolicy, a as resolveOpenClawUserDataDir, b as fetchOk, c as resolveBrowserExecutableForPlatform, f as normalizeCdpWsUrl, g as assertBrowserNavigationResultAllowed, h as assertBrowserNavigationAllowed, i as launchOpenClawChrome, j as DEFAULT_TRACE_DIR, l as captureScreenshot, m as InvalidBrowserNavigationUrlError, n as isChromeCdpReady, o as stopOpenClawChrome, p as snapshotAria, r as isChromeReachable, u as createTargetViaCdp, v as appendCdpPath, w as stopChromeExtensionRelayServer, y as fetchJson } from "./chrome-BHUiBOEy.js";
import { a as syncSkillsToWorkspace, l as resolveSandboxInputPath, m as sanitizeEnvVars, u as resolveSandboxPath } from "./skills-D2smCxoJ.js";
import { n as extractErrorCode, r as formatErrorMessage } from "./errors-CtjhsMeB.js";
...
import { t as sanitizeContentBlocksImages } from "./tool-images-0DttJvTG.js";
...
async function loadPwAiModule(mode) {
	try {
		return await import("./pw-ai-6MPHjZ-S.js");
	} catch (err) {
...
async function closePlaywrightBrowserConnection() {
	try {
		await (await import("./pw-ai-6MPHjZ-S.js")).closePlaywrightBrowserConnection();
	} catch {}
}
