import { I as resolvePathViaExistingAncestorSync, O as runExec, Q as buildAgentMainSessionKey, S as ensureAgentWorkspace, X as DEFAULT_AGENT_ID, _ as DEFAULT_HEARTBEAT_FILENAME, at as resolveAgentIdFromSessionKey, b as DEFAULT_TOOLS_FILENAME, dt as normalizeOptionalAccountId, f as resolveSessionAgentId, g as DEFAULT_BOOTSTRAP_FILENAME, h as DEFAULT_AGENT_WORKSPACE_DIR, i as resolveAgentConfig, it as normalizeMainKey, j as openBoundaryFile, m as DEFAULT_AGENTS_FILENAME, q as normalizeHyphenSlug, rt as normalizeAgentId, v as DEFAULT_IDENTITY_FILENAME, x as DEFAULT_USER_FILENAME, y as DEFAULT_SOUL_FILENAME } from "./run-with-concurrency-8rEOAFIb.js";
import { C as parseDurationMs, Hn as resolveProcessScopedMap, Ir as formatCliCommand, It as containsEnvVarReference, S as getBlockedNetworkModeReason, Un as getProcessStartTime, Wn as isPidAlive, cr as hasConfiguredSecretInput, dr as resolveSecretInputRef, fr as CHANNEL_IDS, i as loadConfig, ir as parseBooleanValue, kn as resolveSecretRefValues, l as writeConfigFile, or as secretRefKey, t as createConfigIO, w as parseByteSize } from "./config-TChktZcS.js";
...
import { r as normalizeChannelId, x as normalizeChatType } from "./plugins-BH5wDwyt.js";
import { d as getChannelDock, o as normalizeThinkLevel } from "./thinking-RUY0PFjr.js";
import { T as normalizeMessageChannel, i as getImageMetadata, n as buildImageResizeSideGrid, s as resizeToJpeg, t as IMAGE_REDUCE_QUALITY_STEPS, w as listDeliverableMessageChannels } from "./image-ops-XDZEi93j.js";
import { a as resolveSessionTranscriptPathInDir, i as resolveSessionTranscriptPath, n as resolveSessionFilePath, s as resolveStorePath, t as resolveDefaultSessionStorePath } from "./paths-FkFgsZEv.js";
...
import { t as sanitizeContentBlocksImages } from "./tool-images-CGGEZ7Ye.js";
...
async function loadPwAiModule(mode) {
	try {
		return await import("./pw-ai-CX4eJ8ae.js");
	} catch (err) {
...
async function closePlaywrightBrowserConnection() {
	try {
		await (await import("./pw-ai-CX4eJ8ae.js")).closePlaywrightBrowserConnection();
	} catch {}
}
