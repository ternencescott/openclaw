import { g as getImageMetadata, m as buildImageResizeSideGrid, o as listDeliverableMessageChannels, p as IMAGE_REDUCE_QUALITY_STEPS, s as normalizeMessageChannel, y as resizeToJpeg } from "./message-channel-PgXeDkTh.js";
...
import { t as sanitizeContentBlocksImages } from "./tool-images-Dx9X5rtw.js";
import { N as resolvePathViaExistingAncestorSync, O as openBoundaryFile, S as ensureAgentWorkspace, W as normalizeHyphenSlug, Y as buildAgentMainSessionKey, _ as DEFAULT_HEARTBEAT_FILENAME, b as DEFAULT_TOOLS_FILENAME, ct as normalizeOptionalAccountId, et as normalizeAgentId, f as resolveSessionAgentId, g as DEFAULT_BOOTSTRAP_FILENAME, h as DEFAULT_AGENT_WORKSPACE_DIR, i as resolveAgentConfig, m as DEFAULT_AGENTS_FILENAME, nt as resolveAgentIdFromSessionKey, q as DEFAULT_AGENT_ID, tt as normalizeMainKey, v as DEFAULT_IDENTITY_FILENAME, vt as runExec, x as DEFAULT_USER_FILENAME, y as DEFAULT_SOUL_FILENAME } from "./run-with-concurrency-DskKz1MS.js";
import { r as normalizeChannelId, y as normalizeChatType } from "./plugins-C62tP5e_.js";
import { Br as formatCliCommand, Cr as hasConfiguredSecretInput, D as loadConfig, Dr as resolveSecretInputRef, Gn as resolveProcessScopedMap, J as secretRefKey, Kn as getProcessStartTime, M as writeConfigFile, Pn as containsEnvVarReference, Tt as CHANNEL_IDS, X as parseDurationMs, Y as getBlockedNetworkModeReason, Z as parseByteSize, qn as isPidAlive, v as resolveSecretRefValues, w as createConfigIO, zr as parseBooleanValue } from "./model-auth-CmxoFgPT.js";
import { d as getChannelDock, o as normalizeThinkLevel } from "./thinking-B9L3p48O.js";
import { t as SsrFBlockedError } from "./ssrf-CUamt9ig.js";
import { i as writeTextAtomic, r as writeJsonAtomic } from "./json-files-D5o1S-NW.js";
import { a as resolveSessionTranscriptPathInDir, i as resolveSessionTranscriptPath, n as resolveSessionFilePath, s as resolveStorePath, t as resolveDefaultSessionStorePath } from "./paths-Bet0bgXF.js";
import { t as emitSessionTranscriptUpdate } from "./transcript-events-CcZSZF4e.js";
import { A as DEFAULT_DOWNLOAD_DIR, B as DEFAULT_AI_SNAPSHOT_EFFICIENT_MAX_CHARS, C as ensureChromeExtensionRelayServer, D as resolveCdpReachabilityTimeouts, F as resolveWritablePathWithinRoot, L as normalizeBrowserFormField, M as DEFAULT_UPLOAD_DIR, N as resolveExistingPathsWithinRoot, R as isLoopbackHost, T as CDP_JSON_NEW_TIMEOUT_MS, U as DEFAULT_OPENCLAW_BROWSER_COLOR, V as DEFAULT_AI_SNAPSHOT_MAX_CHARS, W as DEFAULT_OPENCLAW_BROWSER_PROFILE_NAME, _ as withBrowserNavigationPolicy, a as resolveOpenClawUserDataDir, b as fetchOk, c as resolveBrowserExecutableForPlatform, f as normalizeCdpWsUrl, g as assertBrowserNavigationResultAllowed, h as assertBrowserNavigationAllowed, i as launchOpenClawChrome, j as DEFAULT_TRACE_DIR, l as captureScreenshot, m as InvalidBrowserNavigationUrlError, n as isChromeCdpReady, o as stopOpenClawChrome, p as snapshotAria, r as isChromeReachable, u as createTargetViaCdp, v as appendCdpPath, w as stopChromeExtensionRelayServer, y as fetchJson } from "./chrome-DlynKb2H.js";
import { a as syncSkillsToWorkspace, l as resolveSandboxInputPath, m as sanitizeEnvVars, u as resolveSandboxPath } from "./skills-DnWOc8Pg.js";
import { t as PATH_ALIAS_POLICIES } from "./path-alias-guards-DME1fctW.js";
import { n as extractErrorCode, r as formatErrorMessage } from "./errors-BB_karnD.js";
import { i as saveMediaBuffer, n as ensureMediaDir } from "./store-C-xvvfxY.js";
...
async function loadPwAiModule(mode) {
	try {
		return await import("./pw-ai-DldOpW2U.js");
	} catch (err) {
...
function resolveBrowserConfig(cfg, rootConfig) {
	...
	const dataDir = cfg?.dataDir?.trim() || void 0;
	return {
		enabled,
		evaluateEnabled,
		controlPort,
...
function createBrowserProfilesService(ctx) {
	...
	const deleteProfile = async (nameRaw) => {
		...
		if (resolveProfile(state.resolved, name)?.cdpIsLoopback) {
			...
			const userDataDir = resolveOpenClawUserDataDir(name, ctx.state().resolved.dataDir);
...
async function closePlaywrightBrowserConnection() {
	try {
		await (await import("./pw-ai-DldOpW2U.js")).closePlaywrightBrowserConnection();
	} catch {}
}
...
function createProfileContext(opts, profile) {
	...
	const { resetProfile } = createProfileResetOps({
		...
		stopRunningBrowser,
		isHttpReachable,
		resolveOpenClawUserDataDir: (name) => resolveOpenClawUserDataDir(name, state().resolved.dataDir)
	});
	return {
		profile,
		ensureBrowserAvailable,
