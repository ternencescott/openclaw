import { I as resolvePathViaExistingAncestorSync, O as runExec, Q as buildAgentMainSessionKey, S as ensureAgentWorkspace, W as normalizeHyphenSlug, X as DEFAULT_AGENT_ID, _ as DEFAULT_HEARTBEAT_FILENAME, at as resolveAgentIdFromSessionKey, b as DEFAULT_TOOLS_FILENAME, dt as normalizeOptionalAccountId, f as resolveSessionAgentId, g as DEFAULT_BOOTSTRAP_FILENAME, h as DEFAULT_AGENT_WORKSPACE_DIR, i as resolveAgentConfig, it as normalizeMainKey, j as openBoundaryFile, m as DEFAULT_AGENTS_FILENAME, rt as normalizeAgentId, v as DEFAULT_IDENTITY_FILENAME, x as DEFAULT_USER_FILENAME, y as DEFAULT_SOUL_FILENAME } from "./run-with-concurrency-B0lSSjmf.js";
import { a as resolveGatewayPort, d as resolveRequiredHomeDir, n as STATE_DIR } from "./paths-eFexkPEh.js";
import { Br as getProcessStartTime, G as parseDurationMs, Hr as formatCliCommand, K as parseByteSize, On as containsEnvVarReference, Or as secretRefKey, Vr as isPidAlive, W as getBlockedNetworkModeReason, Yr as hasConfiguredSecretInput, bt as CHANNEL_IDS, ei as resolveSecretInputRef, i as loadConfig, l as writeConfigFile, t as createConfigIO, ui as parseBooleanValue, xr as resolveSecretRefValues, zr as resolveProcessScopedMap } from "./config-nTkQbTqH.js";
import { C as normalizeE164, D as resolveUserPath, P as truncateUtf16Safe, a as createSubsystemLogger, l as defaultRuntime } from "./logger-DnJ6DlYK.js";
import { d as getChannelDock, o as normalizeThinkLevel } from "./thinking-uLECvLX2.js";
import { T as normalizeMessageChannel, i as getImageMetadata, n as buildImageResizeSideGrid, s as resizeToJpeg, t as IMAGE_REDUCE_QUALITY_STEPS, w as listDeliverableMessageChannels } from "./image-ops-DJMRJUZF.js";
import { ft as normalizeChatType, r as normalizeChannelId } from "./plugins-C5omQoNV.js";
import { a as resolveSessionTranscriptPathInDir, i as resolveSessionTranscriptPath, n as resolveSessionFilePath, s as resolveStorePath, t as resolveDefaultSessionStorePath } from "./paths-Bg689P_I.js";
...
async function loadPwAiModule(mode) {
	try {
		return await import("./pw-ai-1lwfzGxK.js");
	} catch (err) {
...
async function closePlaywrightBrowserConnection() {
	try {
		await (await import("./pw-ai-1lwfzGxK.js")).closePlaywrightBrowserConnection();
	} catch {}
}
