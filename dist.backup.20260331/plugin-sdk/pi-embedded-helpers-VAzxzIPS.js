import { I as resolvePathViaExistingAncestorSync, O as runExec, Q as buildAgentMainSessionKey, S as ensureAgentWorkspace, W as normalizeHyphenSlug, X as DEFAULT_AGENT_ID, _ as DEFAULT_HEARTBEAT_FILENAME, at as resolveAgentIdFromSessionKey, b as DEFAULT_TOOLS_FILENAME, dt as normalizeOptionalAccountId, f as resolveSessionAgentId, g as DEFAULT_BOOTSTRAP_FILENAME, h as DEFAULT_AGENT_WORKSPACE_DIR, i as resolveAgentConfig, it as normalizeMainKey, j as openBoundaryFile, m as DEFAULT_AGENTS_FILENAME, rt as normalizeAgentId, v as DEFAULT_IDENTITY_FILENAME, x as DEFAULT_USER_FILENAME, y as DEFAULT_SOUL_FILENAME } from "./run-with-concurrency-B0Wb-l36.js";
import { $n as isPidAlive, Bn as containsEnvVarReference, D as loadConfig, Gr as parseBooleanValue, Kr as formatCliCommand, M as writeConfigFile, Nr as resolveSecretInputRef, Qn as getProcessStartTime, Zn as resolveProcessScopedMap, et as secretRefKey, jt as CHANNEL_IDS, kr as hasConfiguredSecretInput, nt as parseDurationMs, rt as parseByteSize, tt as getBlockedNetworkModeReason, v as resolveSecretRefValues, w as createConfigIO } from "./model-auth-DF7B1SWS.js";
import { E as truncateUtf16Safe, M as defaultRuntime, O as createSubsystemLogger, h as normalizeE164, y as resolveUserPath } from "./logger-Cxu-Klb_.js";
import { a as resolveGatewayPort, d as resolveRequiredHomeDir, n as STATE_DIR } from "./paths-akVZbnot.js";
import { d as getChannelDock, o as normalizeThinkLevel } from "./thinking-Dam3RCBg.js";
import { r as normalizeChannelId, x as normalizeChatType } from "./plugins-C1UtRrD8.js";
import { t as SsrFBlockedError } from "./ssrf-B9BMRDwY.js";
import { i as writeTextAtomic, r as writeJsonAtomic } from "./json-files-CPqtW_nx.js";
import { T as normalizeMessageChannel, i as getImageMetadata, n as buildImageResizeSideGrid, s as resizeToJpeg, t as IMAGE_REDUCE_QUALITY_STEPS, w as listDeliverableMessageChannels } from "./image-ops-CGOJs1bz.js";
import { a as resolveSessionTranscriptPathInDir, i as resolveSessionTranscriptPath, n as resolveSessionFilePath, s as resolveStorePath, t as resolveDefaultSessionStorePath } from "./paths-CNBdcyu4.js";
import { t as emitSessionTranscriptUpdate } from "./transcript-events-EfXQPW7F.js";
import { A as DEFAULT_DOWNLOAD_DIR, B as DEFAULT_AI_SNAPSHOT_EFFICIENT_MAX_CHARS, C as ensureChromeExtensionRelayServer, D as resolveCdpReachabilityTimeouts, F as resolveWritablePathWithinRoot, L as normalizeBrowserFormField, M as DEFAULT_UPLOAD_DIR, N as resolveExistingPathsWithinRoot, R as isLoopbackHost, T as CDP_JSON_NEW_TIMEOUT_MS, U as DEFAULT_OPENCLAW_BROWSER_COLOR, V as DEFAULT_AI_SNAPSHOT_MAX_CHARS, W as DEFAULT_OPENCLAW_BROWSER_PROFILE_NAME, _ as withBrowserNavigationPolicy, a as resolveOpenClawUserDataDir, b as fetchOk, c as resolveBrowserExecutableForPlatform, f as normalizeCdpWsUrl, g as assertBrowserNavigationResultAllowed, h as assertBrowserNavigationAllowed, i as launchOpenClawChrome, j as DEFAULT_TRACE_DIR, l as captureScreenshot, m as InvalidBrowserNavigationUrlError, n as isChromeCdpReady, o as stopOpenClawChrome, p as snapshotAria, r as isChromeReachable, u as createTargetViaCdp, v as appendCdpPath, w as stopChromeExtensionRelayServer, y as fetchJson } from "./chrome-D1lwShkf.js";
import { a as syncSkillsToWorkspace, l as resolveSandboxInputPath, m as sanitizeEnvVars, u as resolveSandboxPath } from "./skills-Cvb7j9Sf.js";
import { t as PATH_ALIAS_POLICIES } from "./path-alias-guards-4pesaMWH.js";
import { n as extractErrorCode, r as formatErrorMessage } from "./errors-DAKeCDdf.js";
import { i as saveMediaBuffer, n as ensureMediaDir } from "./store-5DbfnhPa.js";
...
import { t as sanitizeContentBlocksImages } from "./tool-images-YgXTYLBg.js";
...
async function loadPwAiModule(mode) {
	try {
		return await import("./pw-ai-m9rysKuE.js");
	} catch (err) {
...
async function closePlaywrightBrowserConnection() {
	try {
		await (await import("./pw-ai-m9rysKuE.js")).closePlaywrightBrowserConnection();
	} catch {}
}
