import { I as resolvePathViaExistingAncestorSync, O as runExec, Q as buildAgentMainSessionKey, S as ensureAgentWorkspace, W as normalizeHyphenSlug, X as DEFAULT_AGENT_ID, _ as DEFAULT_HEARTBEAT_FILENAME, at as resolveAgentIdFromSessionKey, b as DEFAULT_TOOLS_FILENAME, dt as normalizeOptionalAccountId, f as resolveSessionAgentId, g as DEFAULT_BOOTSTRAP_FILENAME, h as DEFAULT_AGENT_WORKSPACE_DIR, i as resolveAgentConfig, it as normalizeMainKey, j as openBoundaryFile, m as DEFAULT_AGENTS_FILENAME, rt as normalizeAgentId, v as DEFAULT_IDENTITY_FILENAME, x as DEFAULT_USER_FILENAME, y as DEFAULT_SOUL_FILENAME } from "./run-with-concurrency-XmKq-xNS.js";
import { $ as getBlockedNetworkModeReason, Ar as resolveSecretInputRef, C as createConfigIO, Dr as hasConfiguredSecretInput, E as loadConfig, Hr as parseBooleanValue, Q as secretRefKey, Rn as containsEnvVarReference, Ur as formatCliCommand, Xn as getProcessStartTime, Yn as resolveProcessScopedMap, Zn as isPidAlive, et as parseDurationMs, j as writeConfigFile, kt as CHANNEL_IDS, tt as parseByteSize, v as resolveSecretRefValues } from "./model-auth-KA9Yo_aB.js";
...
import { t as sanitizeContentBlocksImages } from "./tool-images-DPuUj1eR.js";
...
async function loadPwAiModule(mode) {
	try {
		return await import("./pw-ai--ucrqN9W.js");
	} catch (err) {
...
async function closePlaywrightBrowserConnection() {
	try {
		await (await import("./pw-ai--ucrqN9W.js")).closePlaywrightBrowserConnection();
	} catch {}
}
