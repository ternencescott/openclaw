import { ut as normalizeAccountId } from "./run-with-concurrency-B0Wb-l36.js";
import { D as loadConfig, Ln as resolveTelegramPreviewStreamMode, M as writeConfigFile, Wr as isTruthyEnvValue, Xn as withFileLock$1, k as readConfigFileSnapshotForWrite } from "./model-auth-DF7B1SWS.js";
import { I as danger, O as createSubsystemLogger, R as logVerbose, a as CONFIG_DIR, b as safeParseJson } from "./logger-Cxu-Klb_.js";
...
import { c as resolveTelegramAccount, n as listChannelPlugins, t as getChannelPlugin } from "./plugins-C1UtRrD8.js";
import { c as hasProxyEnvConfigured } from "./ssrf-B9BMRDwY.js";
import { r as writeJsonAtomic } from "./json-files-CPqtW_nx.js";
import { h as normalizeMimeType, m as kindFromMime, p as isGifMedia, u as getFileExtension } from "./image-ops-CGOJs1bz.js";
import { t as redactSensitiveText } from "./redact-BkCa6pJx.js";
import { i as formatUncaughtError, n as extractErrorCode, o as readErrorName, r as formatErrorMessage, t as collectErrorGraphCandidates } from "./errors-DAKeCDdf.js";
import { t as makeProxyFetch } from "./proxy-fetch-o2k_1EOm.js";
import { n as normalizeTelegramLookupTarget, r as parseTelegramTarget, t as normalizeTelegramChatId } from "./targets-C_5PIxsJ.js";
import { a as loadWebMedia, n as markdownToIR, s as resolveMarkdownTableMode, t as chunkMarkdownIR } from "./ir-Ba0ki_Xn.js";
...
import { i as createTelegramRetryRunner, n as recordChannelActivity } from "./channel-activity-BlTF2BxY.js";
import { t as resolveFetch } from "./fetch-CbQacLEh.js";
...
//#endregion
export { removeChannelAllowFromStoreEntry as $, describeReplyTarget as A, resolveTelegramReplyId as B, buildSenderLabel as C, buildTelegramParentPeer as D, buildTelegramGroupPeerId as E, normalizeForwardedContext as F, normalizeDmAllowFromWithStore as G, resolveTelegramThreadSpec as H, resolveTelegramDirectPeerId as I, toLocationContext as J, resolveSenderAllowMatch as K, resolveTelegramForumThreadId as L, extractTelegramLocation as M, getTelegramTextParts as N, buildTelegramThreadParams as O, hasBotMention as P, readChannelAllowFromStore as Q, resolveTelegramGroupAllowFromContext as R, buildGroupLabel as S, buildTelegramGroupFrom as T, isSenderAllowed as U, resolveTelegramStreamMode as V, normalizeAllowFrom as W, isVoiceCompatibleAudio as X, withTelegramApiErrorLogging as Y, addChannelAllowFromStoreEntry as Z, markdownToTelegramHtml as _, reactMessageTelegram as a, firstDefined as at, resolveTelegramFetch as b, sendStickerTelegram as c, resolveGroupAllowFromSources as ct, resolveCronStorePath as d, upsertChannelPairingRequest as et, wasSentByBot as f, markdownToTelegramChunks as g, isRecoverableTelegramNetworkError as h, editMessageTelegram as i, listPairingChannels as it, expandTextLinks as j, buildTypingThreadParams as k, resolveTelegramVoiceSend as l, isRpcEnabled as m, createForumTopicTelegram as n, writeJsonFileAtomically as nt, sendMessageTelegram as o, isSenderIdAllowed as ot, createRpcTransformer as p, formatLocationText as q, deleteMessageTelegram as r, getPairingAdapter as rt, sendPollTelegram as s, mergeDmAllowFromSources as st, buildInlineKeyboard as t, readJsonFileWithFallback as tt, loadCronStore as u, renderTelegramHtmlText as v, buildSenderName as w, splitTelegramCaption as x, wrapFileReferencesInHtml as y, resolveTelegramMediaPlaceholder as z };
