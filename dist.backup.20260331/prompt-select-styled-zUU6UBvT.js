import { g as getResolvedLoggerSettings } from "./globals-Bv4ZcVWM.js";
...
import { Ar as resolveHooksGmailModel, Bi as DEFAULT_PROVIDER, G as readConfigFileSnapshot, Hi as CLAUDE_CLI_PROFILE_ID, Jn as repairOAuthProfileIdMismatch, Or as resolveConfiguredModelRef, Ui as CODEX_CLI_PROFILE_ID, Y as writeConfigFile, d as resolveApiKeyForProfile, hi as resolveApiKeyForProvider, l as resolveProfileUnusableUntilForDisplay, nr as ensureAuthProfileStore, or as updateAuthProfileStoreWithLock, vr as getModelRefStatus, zi as DEFAULT_MODEL } from "./auth-profiles-mTj_3EiL.js";
import { t as formatCliCommand } from "./command-format-BTnLVWI8.js";
import { a as resolveAgentDir, d as resolveDefaultAgentId, g as DEFAULT_AGENTS_FILENAME, u as resolveAgentWorkspaceDir } from "./agent-scope-DF-nzI8H.js";
import { E as parseAgentSessionKey } from "./session-key-51LnISpq.js";
import { S as sleep, v as resolveUserPath, x as shortenHomePath } from "./utils-C5WN6czr.js";
import { t as resolveOpenClawPackageRoot } from "./openclaw-root-DFJGXT24.js";
...
import { Bt as DEFAULT_OAUTH_WARN_MS, Ht as formatRemainingShort, Sr as resolveBootstrapContextForRun, Vt as buildAuthHealthSummary, c as loadOpenClawPlugins, dr as analyzeBootstrapBudget, fr as buildBootstrapInjectionStats, gr as resolveAgentSessionDirs } from "./compact-DYAmGi3u.js";
import { n as listChannelPlugins } from "./plugins-BkoiCBu-.js";
import { B as resolveBootstrapTotalMaxChars, R as resolveBootstrapMaxChars } from "./pi-embedded-helpers-CMEderlr.js";
import { E as DEFAULT_SANDBOX_BROWSER_IMAGE, O as DEFAULT_SANDBOX_IMAGE, p as resolveSandboxScope } from "./sandbox-Dd2Cr63Z.js";
import { d as resolveGatewayBindHost, i as isLoopbackHost } from "./ws-lgJJfM9Q.js";
...
import { n as resolveConfiguredSecretInputWithFallback } from "./resolve-configured-secret-input-string-BQCPKZxv.js";
import { n as inspectPortUsage, o as formatPortDiagnostics } from "./ports-DOBLq-G-.js";
import { at as formatSessionArchiveTimestamp, et as resolveMainSessionKey, ot as isPrimarySessionTranscriptFileName, s as loadSessionStore, ut as cleanStaleLockFiles } from "./sessions-BqrgkUq8.js";
import { c as resolveStorePath, n as resolveSessionFilePath, r as resolveSessionFilePathOptions, s as resolveSessionTranscriptsDirForAgent } from "./paths-BCX3TKIK.js";
import { n as loadModelCatalog } from "./model-catalog-BrnDjT5b.js";
import { n as callGateway, t as buildGatewayConnectionDetails } from "./call-XXMjkaQj.js";
import { l as resolveDmAllowState } from "./pi-tools.policy-RLprM2gi.js";
import { g as resolveNodeLaunchAgentLabel, m as resolveGatewayWindowsTaskName, p as resolveGatewaySystemdServiceName, u as resolveGatewayLaunchAgentLabel } from "./arg-split-DJKZOqeG.js";
import { r as isWSLEnv, t as isWSL } from "./wsl-DoM4GibX.js";
import { h as randomToken, n as applyWizardMetadata, p as printWizardHeader, s as guardCancel } from "./onboard-helpers-BZvS4-ob.js";
import { n as stylePromptMessage, r as stylePromptTitle, t as stylePromptHint } from "./prompt-style-Bcr283QM.js";
import { i as resolveMemoryBackendConfig } from "./memory-cli-BFAWzUOR.js";
import { i as resolveMemorySearchConfig, r as hasConfiguredMemorySecretInput } from "./manager-D3msdE3r.js";
import { t as buildWorkspaceSkillStatus } from "./skills-status-B-LyfH6C.js";
import { t as note$1 } from "./note-DITQCNUf.js";
import { t as collectChannelStatusIssues } from "./channels-status-issues-B0WC0NAB.js";
import { a as renderSystemNodeWarning, o as resolveSystemNodeInfo } from "./daemon-install-plan.shared-D06v-8EB.js";
...
import { i as isSystemdUserServiceAvailable, u as uninstallLegacySystemdUnits } from "./systemd-YuA-rlM2.js";
import { a as launchAgentPlistExists, i as isLaunchAgentLoaded, o as repairLaunchAgentBootstrap, r as isLaunchAgentListed, t as resolveGatewayService } from "./service-D4k98v0P.js";
import { c as buildPlatformRuntimeLogHints, i as auditGatewayServiceConfig, n as renderSystemdUnavailableHints, o as needsNodeRuntimeMigration, r as SERVICE_AUDIT_CODES, s as readEmbeddedGatewayToken, t as isSystemdUnavailableDetail, u as formatRuntimeStatus } from "./systemd-hints-CXa8jzon.js";
...
import { r as healthCommand } from "./health-DxzllMcV.js";
import { n as resolveControlUiDistIndexHealth, r as resolveControlUiDistIndexPathForRoot } from "./control-ui-assets-0Xxy9Jtx.js";
import { t as resolveDefaultChannelAccountContext } from "./channel-account-context-D-mDIqSp.js";
import { t as runGatewayUpdate } from "./update-runner-BsoSS-ua.js";
import { n as logConfigUpdated } from "./logging-BfIBddi5.js";
import { n as noteOpenAIOAuthTlsPrerequisites } from "./oauth-tls-preflight-CQgpdHbh.js";
import { n as detectLegacyStateMigrations, r as runLegacyStateMigrations, t as loadAndMaybeMigrateDoctorConfig } from "./doctor-config-flow-CEm78YPd.js";
import { t as ensureSystemdUserLingerInteractive } from "./systemd-linger-HYaYXryo.js";
import { t as formatHealthCheckFailure } from "./health-format-CSNUS7OB.js";
import { n as doctorShellCompletion } from "./doctor-completion-tOQ_IEev.js";
