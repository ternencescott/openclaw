...
import { en as createConfigIO, rn as loadConfig, un as writeConfigFile } from "./model-selection-D5oXKIQF.js";
...
import { n as hasGatewayPasswordEnvCandidate, o as readGatewayTokenEnv, r as hasGatewayTokenEnvCandidate } from "./credentials-DLFMFSug.js";
import { t as assertExplicitGatewayAuthModeWhenBothConfigured } from "./auth-mode-policy-DvlVkCHy.js";
import { r as resolveRequiredConfiguredSecretRefInputString } from "./resolve-configured-secret-input-string-1uhDrMYD.js";
import { c as normalizeBrowserFormField, i as resolveExistingPathsWithinRoot, n as DEFAULT_TRACE_DIR, o as resolveWritablePathWithinRoot, r as DEFAULT_UPLOAD_DIR, t as DEFAULT_DOWNLOAD_DIR } from "./paths-TP02AE1K.js";
import { n as extractErrorCode, r as formatErrorMessage } from "./errors-Dl9nRyXH.js";
import { n as SsrFBlockedError } from "./proxy-env-CgT7MSRs.js";
import { i as getImageMetadata, n as buildImageResizeSideGrid, s as resizeToJpeg, t as IMAGE_REDUCE_QUALITY_STEPS } from "./image-ops-v9o00YrC.js";
import { a as saveMediaBuffer, r as ensureMediaDir } from "./store-CCWPL_3R.js";
...
async function loadPwAiModule(mode) {
	try {
		return await import("./pw-ai-DFwmTSNt.js");
	} catch (err) {
...
async function closePlaywrightBrowserConnection() {
	try {
		await (await import("./pw-ai-DFwmTSNt.js")).closePlaywrightBrowserConnection();
	} catch {}
}
