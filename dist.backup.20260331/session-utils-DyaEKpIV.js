import { U as consumeRootOptionToken } from "./globals-Bv4ZcVWM.js";
import { g as resolveStateDir } from "./paths-BfR2LXbA.js";
import { At as AVATAR_MAX_BYTES, Bi as DEFAULT_PROVIDER, H as loadConfig, It as isWorkspaceRelativeAvatarPath, Mt as isAvatarHttpUrl, Or as resolveConfiguredModelRef, Pt as isPathWithinRoot, Rt as resolveAvatarMime, Tr as parseModelRef, jt as isAvatarDataUrl, kr as resolveDefaultModelForAgent, lr as resolveOpenClawAgentDir, yr as inferUniqueProviderFromConfiguredModels, zi as DEFAULT_MODEL } from "./auth-profiles-mTj_3EiL.js";
import { d as resolveDefaultAgentId, u as resolveAgentWorkspaceDir } from "./agent-scope-DF-nzI8H.js";
import { C as isCronRunSessionKey, E as parseAgentSessionKey, c as normalizeAgentId, l as normalizeMainKey } from "./session-key-51LnISpq.js";
import { a as openBoundaryFileSync } from "./openclaw-root-DFJGXT24.js";
import { N as readSessionTitleFieldsFromTranscript, Q as resolveAgentMainSessionKey, T as normalizeSessionDeliveryFields, Y as resolveFreshSessionTotalTokens, Z as canonicalizeMainSessionAlias, et as resolveMainSessionKey, s as loadSessionStore, st as buildGroupDisplayName } from "./sessions-BqrgkUq8.js";
...
function ensureContextWindowCacheLoaded() {
	...
	loadPromise = (async () => {
		...
		try {
			const { discoverAuthStorage, discoverModels } = await import("./pi-model-discovery-CN3fiV3-.js").then((n) => n.r);
