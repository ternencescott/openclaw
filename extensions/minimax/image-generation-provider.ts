...
const DEFAULT_MINIMAX_IMAGE_BASE_URL = "https://api.minimaxi.com";
...
function resolveMinimaxImageBaseUrl(
  ...
  // Allow env var override for proxied deployments (e.g. HoldClaw containers)
  const envOverride = typeof process !== "undefined" ? process.env.MINIMAX_IMAGE_BASE_URL : undefined;
  if (envOverride?.trim()) {
